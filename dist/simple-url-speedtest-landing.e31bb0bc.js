...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../node/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
function runTest() {
  var speedContainer = (0, _jquery.default)(".speed-wrapper");
  /**
   * Insert dummy loading data
   */

  var dummyData = speedArr.map(function (item) {
  ...
  (0, _simpleUrlSpeedtest.default)(speedArr, function (data) {
    ...
    var highestPing = sortedData[sortedData.length - 1].ping;
    var speedItems = sortedData.map(function (item) {
      var url = item.url,
          ping = item.ping;
      var currentSpeed = Math.floor(ping / highestPing * 100);
      return "<div class=\"speed-item\">\n          <div class=\"label\">".concat(url, "</div>\n          <div class=\"progress-wrapper\">\n            <div\n              class=\"progress\"\n              style=\"transform: translateX(-").concat(100 - currentSpeed, "%)\"\n            ></div>\n          </div>\n          <div class=\"ping\">").concat(ping, "ms</div>\n        </div>");
    }).join("");
    speedContainer.html((0, _jquery.default)(speedItems));
  });
}

function setVersion() {
  var API_ENDPOINT = "https://raw.githubusercontent.com/masonwongcs/simple-url-speedtest/master/package.json";
  var version = (0, _jquery.default)(".version-wrapper span");

  _jquery.default.ajax(API_ENDPOINT, {
...
(0, _jquery.default)(document).ready(function () {
  setVersion();
  runTest();
  (0, _jquery.default)(".refresh-button").click(function (e) {
    e.preventDefault();
    console.log("asd");
    runTest();
  });
...
},{}]},{},["../../node/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/simple-url-speedtest-landing.e31bb0bc.js.map